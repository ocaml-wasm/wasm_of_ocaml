...
(module
   ...
   (import "jsstring" "jsbytes_of_bytes"
      (func $jsbytes_of_bytes (param (ref $string)) (result anyref)))
  ...
  (func (export "caml_js_pure_expr")
   ...
   (func $caml_jsstring_of_string (export "caml_jsstring_of_string")
      (param (ref eq)) (result (ref eq))
      ;; ZZZ convert non-ASCII strings
;; (local.get 0)
      (call $wrap (call $utf16_of_utf8 (call $unwrap (local.get 0))))
)
   ...
   (func $caml_string_of_jsstring (export "caml_string_of_jsstring")
      ...
      ;; ZZZ non-ascii characters
      ;;(local.get 0))
      (call $wrap (call $utf8_of_utf16 (call $unwrap (local.get 0))))
)
