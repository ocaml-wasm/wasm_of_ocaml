...
(module
   ...
   (func (export "caml_bytes_notequal")
      (param $p1 (ref eq)) (param $p2 (ref eq)) (result (ref eq))
      (return
   ...
   (func (export "caml_bytes_compare")
   ...
   (func (export "caml_bytes_lessequal")
      (param (ref eq)) (param (ref eq)) (result (ref eq))
   ...
   (func (export "caml_bytes_lessthan")
      (param (ref eq)) (param (ref eq)) (result (ref eq))
   ...
   (func (export "caml_bytes_greaterequal")
      (param (ref eq)) (param (ref eq)) (result (ref eq))
   ...
   (func (export "caml_bytes_greaterthan")
      (param (ref eq)) (param (ref eq)) (result (ref eq))
