...
(module
   ...
   (func $in_bitset (param $s externref) (param $c i32) (result i32)
      (i32.and (i32.const 1)
         (i32.shr_u
   ...
   (func $re_match
      (param $vre (ref eq)) (param $s externref) (param $pos i32)
      (param $accept_partial_match i32) (result (ref eq))
      (local $res (ref $block))
      (local $s' externref) (local $set externref)
   ...
   (func (export "re_search_forward")
      ...
      (local.set $s
         (extern.convert_any
            (struct.get $string 0
               (ref.cast (ref $string) (local.get $vs)))))
   ...
   (func (export "re_replacement_text")
      ...
      (local.set $repl
         (extern.convert_any
            (struct.get $string 0
               (ref.cast (ref $string) (local.get $vrepl)))))
